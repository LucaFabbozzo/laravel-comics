...
@section('content')
    ...
    <div class="card">
        <a href="{{route('shop')}}"><img src="https://www.dccomics.com/sites/default/files/styles/covers192x291/public/comic-covers/2018/09/AC1000_DLX_162-001_HD_5ba13723281ab0.37845353.jpg?itok=ZsI-C5eX" alt="Action Comics"></a>
        <h4>Action Comics</h4>
    </div>
      <div class="card">
      ...
      <div class="card">
        <img src="https://www.dccomics.com/sites/default/files/styles/covers192x291/public/comic-covers/2018/09/BM_56_300-001_HD_5ba137a85c3bf3.33122291.jpg?itok=3FHJQYJZ" alt="Batman Beyon">
        <h4>Batman Beyon</h4>
    </div>
      <div class="card">
